        ...
        var x=document.getElementById("loger");
...
function loginer(){
    ...
    if(login!=false && login_m!=false ){
        ...
        document. getElementById('info'). style. backgroundColor = 'rgb(50,255,50)' ;
        document.getElementById("dwsa").innerHTML="Logged in with<br>Username:"+un;
